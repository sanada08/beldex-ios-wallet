...
class TableViewPlaceholder: UIView {
    ...
    lazy var descriptionLabel: UILabel = {
        ...
        descriptionLabel.textColor = UIColor.lightText//AppTheme.Color.text_light
    ...
    lazy var bottomButton: UIButton = {
        let button = UIButton()
        button.setTitleColor(UIColor.black, for: .normal)//AppTheme.Color.button_title
        button.titleLabel?.font = AppTheme.Font.text_normal
        button.contentEdgeInsets = UIEdgeInsets(top: 0, left: 40, bottom: 0, right: 40)
        button.setBackgroundImage(UIImage.colorImage(UIColor.blue), for: .normal)//AppTheme.Color.main_blue
