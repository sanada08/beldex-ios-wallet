...
public struct TransactionItem {
                ...
                confirmations: UInt64)
    {
        ...
        self.amount = BeldexWalletWrapper.displayAmount(amount)
        self.networkFee = BeldexWalletWrapper.displayAmount(networkFee)
    ...
    public init(model: BeldexTrxHistory)
    {
        ...
        self.amount = BeldexWalletWrapper.displayAmount(model.amount)
        self.networkFee = BeldexWalletWrapper.displayAmount(model.fee)
